...
**[下载最新版 APK](https://github.com/Buzzzohu/smart-clipboard/releases/latest/download/Smart-Clipboard-0.10.2-category-search.apk)** · [查看版本发布页](https://github.com/Buzzzohu/smart-clipboard/releases)

> 当前版本：0.10.2。仓库目前为私有仓库，下载 Release 需要登录有访问权限的 GitHub 账号。

本次更新：聊天框输入完整分类名，即可优先查看该分类全部候选内容，支持上下滚动；未匹配分类名时沿用正文联想与模糊匹配。分类管理入口固定在侧边栏底部，四个原有分类恢复各自的默认图标。保留自定义图片图标、悬浮窗透明度和各应用联想开关。

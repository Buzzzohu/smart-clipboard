...
**[下载最新版 APK](https://github.com/Buzzzohu/smart-clipboard/releases/latest/download/Smart-Clipboard-0.9.7-position.apk)** · [查看版本发布页](https://github.com/Buzzzohu/smart-clipboard/releases)

> 当前版本：0.9.7。仓库目前为私有仓库，下载 Release 需要登录有访问权限的 GitHub 账号。

本次更新：候选框首次绘制前先校准窗口坐标，避免先在下方出现、再跳回正确位置；保留键盘跟随和退出隐藏。实际手机观感待验证。
